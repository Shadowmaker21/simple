...
if (isset($_POST['Input'])) {
	...
	$sanksi = addslashes(strip_tags($_POST['sanksi']));
	...
	if (strlen($nama_file) > 0) {
		...
		if (is_uploaded_file($_FILES['file']['tmp_name'])) {
			move_uploaded_file($_FILES['file']['tmp_name'], "files/surat/" . $nama_file);
		}
	}

	$query = "INSERT INTO surat VALUES('','$jenis_srt','$sanksi','$nomor_srt','$ket','$nama_file')";
...
<div id="content">
	...
	<FORM ACTION="" METHOD="POST" NAME="input" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" border="0" width="700">
			...
			<tr>
				<td width="200">Jenis Sanksi</td>
				<td>:	<select class="js-example-basic-multiple" name="sanksi[]" multiple="multiple">
...
A
			<tr>
				<td>Nomor Surat</td>
				<td>: <input type="text" name="nomor_srt" size="30"></td>
			</tr>
